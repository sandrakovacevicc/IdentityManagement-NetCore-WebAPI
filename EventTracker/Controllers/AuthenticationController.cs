...
namespace EventTracker.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterUser registerRequest)
        {
            ...
            var token = await _user.CreateUserWithTokenAsync(registerRequest);
            var confirmationLink = Url.Action(nameof(ConfirmEmail), "Authentication", new { token, email = registerRequest.Email }, Request.Scheme);
